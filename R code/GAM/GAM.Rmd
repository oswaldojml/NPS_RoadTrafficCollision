...
# load("../../clean data/functional/df_week.RData")
...
```{r}
# df_week[,3:ncol(df_week)] %>% t() %>% matplot(type = "l")
```
...
#com: the number if uniquie values in speed_limit is low, so we need to specify k
```
